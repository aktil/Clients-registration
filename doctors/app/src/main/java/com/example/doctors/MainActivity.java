...
//        menu.setOnClickListener(viewClickListener);
    ...
    void initList(){
        docs.add(new Doctor("Сапар", "+996704774106","Травматолог", R.drawable.doc));
        docs.add(new Doctor("Эрлан", "+996707418989","Медбрат", R.drawable.doc1));
        docs.add(new Doctor("Aзим", "+996707414989","Хирург", R.drawable.doc2));
        docs.add(new Doctor("Каникей", "+996505133399","Кардиолог", R.drawable.doc3));
        docs.add(new Doctor("Аман", "+996999324564","Терапефт", R.drawable.doc4));
        docs.add(new Doctor("Шернияз", "+996701245678","Акушер", R.drawable.doctor_default_man));
        docs.add(new Doctor("Хадийча", "+996551355673","Уролог", R.drawable.doctor_defoult_women));
        docs.add(new Doctor("Кумар", "+996777888999","Кардиохирург", R.drawable.doctor_default_man));
        docs.add(new Doctor("Айжамал", "+996707780989","Глав врач", R.drawable.doc6));
